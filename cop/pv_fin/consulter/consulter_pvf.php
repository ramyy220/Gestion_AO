...
<html>
    <head>
        ...
        <link rel="stylesheet" href="style_consulter_pvf.css">
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="title">Consulter un PV COP Financier</div>
                <a href="../accueil/accueil_pvf.php" id="return"> Retourner à la page d'accueil </a>
                        ...
                        <div class="button">
                            <button onclick="location='../accueil/accueil_pvf.php'">Retourner</a>
                        </div>
