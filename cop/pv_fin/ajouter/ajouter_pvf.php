...
<?php include ("ajouter_connect_pvf.php"); ?>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="style_ajouter_pvf.css">
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="title">Ajouter un PV Financier</div>
                <a href="../accueil/accueil_pvf.php" id="return"> Retourner à la page d'accueil </a>

                <div class="formulaire">

                    <form method="POST" action="ajouter_connect_pvf.php">
                    ...
                    <div class="button">
                                <button onclick="location='../accueil/accueil_pvf.php'">Annuler</a>
                            </div>
