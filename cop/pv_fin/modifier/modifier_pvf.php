...
<?php include ('modifier_connect_pvf.php'); ?>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="style_modifier_pvf.css">
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="title">Modifier un PV Financier</div>
                <a href="../accueil/accueil_pvf.php" id="return"> Retourner à la page d'accueil </a>

                <div class="formulaire">

                    <form method="POST" action="modifier_connect_pvf.php">
                    <?php 
