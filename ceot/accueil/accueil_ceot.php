...
<?php 
    ...
    $query="SELECT ref_PV, date_PV, ref_AO, objet_PV FROM pv where type_PV = 'CEOT'  ";
...
<html>
    <head>
        <meta charset="UTF-8">
        <link rel="stylesheet" href="style_accueil_ceot.css?1422585377">
    ...
    <div class="headerr">
        ...
        <div class="content">
            <div class="container">
                <div class="title">PV CEOT</div>
                <a href="../ajouter/ajouter_ceot.php"> Ajouter un PV CEOT </a>
                ...
                <table class="tab" >
                    ...
                    <tr>
                        ...
                        <td style="width:13%"> <div class="consult"> <button onclick="location = '../consulter/consulter_ceot.php?ref_pv=<?php echo $rows['ref_PV']; ?>'" style='font-size:20px'><i class='fa fa-search'></i></button> </div> </td>
                        <td style="width:13%"> <div class="edit"> <button onclick="location = '../modifier/modifier_ceot.php?ref_pv=<?php echo $rows['ref_PV']; ?>'" style='font-size:20px'><i class='fas fa-pen'></i> </button> </div> </td>
