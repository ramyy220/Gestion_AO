...
<?php include('ajouter_connect_ceot.php'); ?>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="style_ajouter_ceot.css">
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="title">Ajouter un PV CEOT</div>
                <a href="../accueil/accueil_ceot.php" id="return"> Retourner à la page d'accueil </a>

                <div class="formulaire">

                    <form method="POST" action="ajouter_connect_ceot.php">
