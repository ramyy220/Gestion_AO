...
<?php include ('modifier_connect_ceot.php'); ?>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="style_modifier_ceot.css">
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="title">Modifier un PV CEOT</div>
                <a href="../accueil/accueil_ceot.php" id="return"> Retourner à la page d'accueil </a>

                <div class="formulaire">

                    <form method="POST" action="modifier_connect_ceot.php">
                        <?php 
                    ...
                    <div class="button">
                        <button onclick="location='../accueil/accueil_ceot.php'">Annuler</a>
                    </div>
