...
<html>
    <head>
        ...
        <link rel="stylesheet" href="style_consulter_cc.css">
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="title">Consulter un Cahier de Charges</div>
                <a href="../accueil/accueil_cc.php" id="return"> Retourner à la page d'accueil </a>
                        ...
                        <div class="form">
                            ...
                            <div class="box">
                                ...
                                <p> <?php echo $rows['objet_CC']; ?> </p>
                            </div>
                            <div class="box">
                                <span class="details">Date de création:</span>
                                <p> <?php echo $rows['date_creation_CC']; ?> </p>
                            </div>
                            <div class="box">
                                <span class="details">Durée de la garantie:</span>
                                <p> <?php echo $rows['duree_garantie']; ?> jours </p>
                            </div>
                            <div class="box">
                                <span class="details">Montant:</span>
                                <p> <?php echo $rows['montant_CC']; ?> DA </p>
                            </div>
                            <div class="box">
                                <span class="details">Observation:</span>
                                <p> <?php echo $rows['observation_CC']; ?> </p>
                            </div>
                        </div>
                            <?php
                                }
                        ...
                        <div class="button">
                            <button onclick="location='../accueil/accueil_cc.php'">Retourner</a>
                        </div>
