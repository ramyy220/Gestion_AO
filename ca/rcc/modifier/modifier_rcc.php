...
<?php include ("modifier_connect_rcc.php"); ?>
...
<?php 
    ...
    $query = "SELECT * from registre_retrait_cahier_charges where num_ordre_retrait = '$num_ord'";
...
<html>
    <head>
        <?php 
            include ("modifier_connect_rcc.php"); 
        ?>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <link rel="stylesheet" href="style_modifier_rcc.css?1422585377">
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="title">Modifier un Retrait de Cahier de Charges</div>
                <a href="../accueil/accueil_rcc.php" id="return"> Retourner à la page d'accueil </a>

                <div class="formulaire">

                    <form method="POST" action="modifier_connect_rcc.php">
                        <?php 
                        ...
                        <div class="user-details">
                            <div class="input-box">
                                ...
                                <input type="text" name="num_ordre" value="<?php echo $rows['num_ordre_retrait']; ?>"  required>
                            </div>
                            <div class="input-box">
                                <span class="details">Date de retrait : </span>
                                <input type="date" name="dateR" value="<?php echo $rows['date_retrait']; ?>"  required>
                            </div>
                            <div class="input-box">
                                <span class="details">Nom :</span>
                                <input type="text" name="nom" value="<?php echo $rows['nom_retrait']; ?>" required>
                            </div>
                            <div class="input-box">
                                <span class="details">Prénom :</span>
                                <input type="text" name="prenom" value="<?php echo $rows['prenom_retrait']; ?>" required>
                            </div>
                            <div class="input-box">
                                <span class="details"> Observation :</span>
                                <input type="text" name="obs" value="<?php echo $rows['observation_retrait']; ?>" required>
                            </div>
                            <div class="input-box">
