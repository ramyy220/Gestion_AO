...
<?php include('modifier_connect_pla.php'); ?>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="style_modifier_pla.css">
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="title">Modifier un Placard</div>
                <a href="../accueil/accueil_pla.php" id="return"> Retourner à la page d'accueil </a>

                <div class="formulaire">

                    <form method="POST" action="modifier_connect_pla.php">
                        <?php 
                        ...
                        <div class="user-details">
                            <div class="input-box">
                                ...
                                <input type="text" name=" ref_pla" value="<?php echo $rows['ref_placard']; ?>" readonly="readonly" required>
                            </div>
                            <div class="input-box">
                                <span class="details">Date de Création : </span>
                                <input type="date" name="date" value="<?php echo $rows['date_creation_placard']; ?>" required>
                            </div>
                            <div class="input-box">
                                <span class="details">Objet :</span>
                                <input type="text" name="obj" value="<?php echo $rows['objet_placard']; ?>" required>
                            </div>
                            <div class="input-box">
