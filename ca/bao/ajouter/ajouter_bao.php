...
<html>
    <head>
        ...
        <link rel="stylesheet" href="style_ajouter_bao.css">
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="title">Ajouter un BAOSEM</div>
                <a href="../accueil/accueil_bao.php" id="return"> Retourner à la page d'accueil </a>

                <div class="formulaire">

                    <form method="POST" action="ajouter_connect_bao.php">

                        <div class="user-details">
                            <div class="input-box">
                                <span class="details">Numéro du BAOSEM :</span>
                                <input type="text" name="num_bao" id="num_bao" placeholder="Veuillez saisir le numéro" required>
                            </div>
                            <div class="input-box">
                            ...
                            <div class="input-box">
                                ...
                                <input type="text" name="descr" id="descr" placeholder="Veuillez saisir la description" required>
                            </div>
                        </div>
                            <div class="button">
